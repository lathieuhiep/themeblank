...
function themeblank_get_responsive_row_class($per_row): string
{
...
function themeblank_get_footer_sidebar_columns_count (): int
{
    return themeblank_opt(FooterOptions::class)::get_footer_sidebar_columns_count() ?? 4;
}